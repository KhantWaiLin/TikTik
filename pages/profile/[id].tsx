    ...
    <div className="w-full">
      ...
      <div className='w-16 h-16 md:w-32 md:h-32'>
            ...
            <div className="flex flex-col justify-center">
              <p className='md:text-2xl flex gap-1 items-center 
              tracking-wider justify-center text-md font-bold text-primary lowercase'>
      ...
      <div>
        ...
        bg-white w-full">
          ...
          <p className={`text-xl font-semibold cursor-pointer mt-2 ${likedVideos}`}
